...
// URL RESERVA (PHP)
// =====================================
const PUBLIC_BASE_URL = process.env.PUBLIC_BASE_URL || "https://mona-hospitality-management-2b2c53a0.base44.app/Reservas";
const RESERVA_URL = `${PUBLIC_BASE_URL.replace(/\/$/, "")}/Reservas`;
...
function buildSystemPrompt() {
  return (
    ...
    `Seu papel é responder dúvidas com simpatia, clareza, objetividade e humanizada. Use icones para simpatizar seu atendimento\n\n` +
    `REGRAS:\n` +
